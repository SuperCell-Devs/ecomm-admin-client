                            ...
                            <Tab.Container defaultActiveKey="emailLogin">
                                ...
                                <div className="lg:w-[25rem] mx-auto">
                                    ...
                                    <div className="mt-10 text-center">
                                        <p className="mb-0 text-slate-500 dark:text-zink-200">Dont have an account ? <Link to="/auth-register-modern" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500"> SignUp</Link> </p>
                                    </div>
