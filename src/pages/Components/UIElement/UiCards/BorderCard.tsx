...
const BorderCard = () => {
    return (
        <React.Fragment>
            <h5 className="mb-5 underline">Border Card</h5>
            <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="border border-green-200 card dark:border-green-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Green Card
                        </h6>
                ...
                <div className="border border-orange-200 card dark:border-orange-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Orange Card
                        </h6>
                ...
                <div className="border card border-sky-200 dark:border-sky-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Sky Card
                        </h6>
                ...
                <div className="border border-yellow-200 card dark:border-yellow-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Yellow Card
                        </h6>
                ...
                <div className="border border-red-200 card dark:border-red-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Red Card
                        </h6>
                ...
                <div className="border border-purple-200 card dark:border-purple-800">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Purple Card
                        </h6>
                ...
                <div className="border card border-slate-200 dark:border-zink-500">
                    <div className="card-body">
                        <h6 className="mb-4 text-15">
                            Slate Card
                        </h6>
