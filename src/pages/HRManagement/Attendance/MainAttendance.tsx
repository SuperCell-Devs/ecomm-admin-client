...
const MainAttendance = () => {
    ...
    const Attendance = ({ item }: any) => {
        switch (item) {
            case true:
                return (<Link to="#!" className="text-green-500 transition-all duration-200 ease-linear hover:text-green-600" onClick={() => setShow(true)}><Check className="size-4" /></Link>);
            case false:
